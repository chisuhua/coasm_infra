...
// It will replace 'NOP' | 'MOV' | 'LD' | 'ST' | 'ADD' | 'SUB' | 'MUL' | 'DIV' | 'MAD' | 'AND' | 'OR' | 'XOR' | 'NOT' | 'SHL' | 'SHR' | 'SETP' | 'SELP' | 'CVT' | 'RCP' | 'SQRT' | 'RSQRT' | 'SIN' | 'COS' | 'EX2' | 'LG2' | 'REM' | 'ABS' | 'MIN' | 'MAX' | 'NEG' | 'CLZ' | 'PRMT' | 'CNOT' | 'S_BRANCH' | 'T_CBRANCH_TCCNZ' | 'T_CBRANCH_TCCZ' | 'T_EXIT' | 'CALL' | 'CALLP' | 'BAR' | 'RED' | 'ATOM' | 'TEX' | 'VMAD' | 'VMAX' | 'VMIN' | 'VSET' | 'DP4A' | 'CHOP' with
// 'ADD' | 'MUL' | 'LD' | 'ST' | 'MOV' | ...
